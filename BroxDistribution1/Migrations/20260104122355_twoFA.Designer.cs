...
namespace BroxDistribution1.Migrations
{
    ...
    [Migration("20260104122355_twoFA")]
    partial class twoFA
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BroxDistribution1.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 1, 4, 13, 23, 42, 852, DateTimeKind.Local).AddTicks(9570),
                            Email = "admin@broxdistribution.com",
                            PasswordHash = "$2a$11$JrDzkycnuBfBvAbkUDtL.uvrGN9kobJoFXQJv4f.hGdl0Rv5Lq/ze",
                            Username = "admin"
                        });
                });

            modelBuilder.Entity("BroxDistribution1.Models.TwoFactorCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BroxDistribution1.Models.TwoFactorCode", b =>
                {
                    b.HasOne("BroxDistribution1.Models.Admin", "Admin")
                        .WithMany()
